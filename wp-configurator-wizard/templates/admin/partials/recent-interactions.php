	...
	<div class="wp-configurator-recent-section">
		<div class="wp-configurator-recent-header">
			<h3 class="wp-configurator-recent-title">
				<span class="dashicons dashicons-clock"></span>
				<?php esc_html_e( 'Recent Interactions', 'wp-configurator' ); ?>
			</h3>
			<button type="button" id="refresh-interactions" class="button button-secondary">
